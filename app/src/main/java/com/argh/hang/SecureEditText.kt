 ...
 *  - keyboard suggestions are disabled
 *  - drag-and-drop text insertion is swallowed
 *  - bulk insertions (clipboard managers, programmatic setText from IMEs)
 *    are rejected by an InputFilter that only accepts small increments
 */
